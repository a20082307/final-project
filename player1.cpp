...
long long int getvalue(int aimx, int aimy) {
    ...
    switch (atknum[1][0] + atknum[1][2]) {
        ...
        case 1: {
            ...
            int left2 = board[aimx][left2_idx], left3 = board[aimx][left3_idx];
            int right2 = board[aimx][right2_idx], right3 = board[aimx][right3_idx];
            if (!(left1 + right1) && ((left2 == player && left3 == player) || (right2 == player && right3 == player))) {
                newval += 15000;
                break;
            } 
            break;
    ...
    switch (atknum[0][1] + atknum[2][1]) {
        ...
        case 1: {
            ...
            int up2 = board[up2_idx][aimy], up3 = board[up3_idx][aimy];
            int down2 = board[down2_idx][aimy], down3 = board[down3_idx][aimy];
            if (!(up1 + down1) && ((up2 == player && up3 == player) || (down2 == player && down3 == player))) {
                newval += 15000;
                break;
            }
    ...
    switch (atknum[0][0] + atknum[2][2]) {
        ...
        case 1: {
            ...
            if (!lu1 && !rd1) {
                ...
                if (!lu2 && !rd2) {
                    ...
                    if (lu3 == enemy && rd3 == enemy) 
                        newval += 7000;  // O__XX__O
                    else if (!sum3)
                        newval += 1000;  // ___XX___
                    else if (sum3 == player)
                        newval += 6100;  // X__XX___  or  ___XX__X
                    else if (sum3 == enemy)
                        newval += 800;  // O__XX___  or  ___XX__O
                    else if (sum3 == 3)
                        newval += 1140;  // O__XX__X  or  X__XX__O
                    ...
                    if (!sum3)
                        ...
                        newval += 1100;  // OX_XX___  or  ___XX_XO
                    else if (sum3 == enemy && lu2 + lu3 != 3)
                    ...
                    if (!sum3)
                        newval += 600;  // _O_XX___  or  ___XX_O_
                    else if (sum3 == player && lu2 + lu3 != 3)
                        newval += 1100;  // _O_XX__X  or  X__XX_O_
                    else if (sum3 == enemy && lu2 + lu3 == enemy)
                        newval += 400;  // _O_XX__O  or  O__XX_O_
                    break;
                    ...
                    if (!sum3)
                        ...
                        newval += 1100;  // _O_XX_XO  or  OX_XX_O_
                    break;
            ...
            int lu2 = board[lu2_x][lu2_y], lu3 = board[lu3_x][lu3_y];
            int rd2 = board[rd2_x][rd2_y], rd3 = board[rd3_x][rd3_y];
            if (!(lu1 + rd1) && ((lu2 == player && lu3 == player) || (rd2 == player && rd3 == player))) {
                newval += 15000;
                break;
            }
            break;
    ...
    switch (atknum[2][0] + atknum[0][2]) {
        ...
        case 1: {
            ...
            int ld2 = board[ld2_x][ld2_y], ld3 = board[ld3_x][ld3_y];
            int ru2 = board[ru2_x][ru2_y], ru3 = board[ru3_x][ru3_y];
            if (!(ld1 + ru1) && ((ld2 == player && ld3 == player) || (ru2 == player && ru3 == player)))
            break;
        }
    }  
    //左下到右上的斜線
...
std::pair<point, long long int> alphabeta(state *aim, int alpha, int beta, int depth, bool isplayer) {
    find_child(aim);

    if (!depth || aim -> child.empty()) {
        long long int ans = getvalue(aim -> x, aim -> y);
        return std::pair<point, long long int> (point(aim -> x, aim -> y), ans);
    }
    ...
    if (isplayer) {
        ...
        for (auto c : aim -> child) {
            board[c -> x][c -> y] = player;
            tem = alphabeta(c, depth - 1, alpha, beta, false);
            board[c -> x][c -> y] = EMPTY;
        ...
        for (auto c : aim -> child) {
            board[c -> x][c -> y] = enemy;
            tem = alphabeta(c, depth - 1, alpha, beta, true);
            board[c -> x][c -> y] = EMPTY;
...
void write_valid_spot(std::ofstream& fout) {
    ...
    if (head -> child.empty()) {
        ...
        // std::pair<point, long long int> result = alphabeta(head, 1, (int)-1e15, (int)1e15, true);
...
// int line[32];  //0-7直線  8-15橫線  16-23 m<0斜線  24-31 m>0斜線
//     for (int i = 0; i < 31; i ++)
//         line[i] = -1;
...
//         if (aimx - i - 1 < 0)
//             continue;
//         line[4 - i - 1] = board[aimx - i - 1][aimy];
//     }
//     for (int i = 0; i < 4; i ++) {
//         if (aimx + i + 1 >= SIZE)
//             continue;
//         line[4 + i] = board[aimx + i + 1][aimy];
//     }
//     for (int i = 0; i < 4; i ++) {
//         if (aimy - i - 1 < 0)
//             continue;
//         line[12 - i - 1] = board[aimx][aimy + i + 1];
//     }
//     for (int i = 0; i < 4; i ++) {
//         if (aimy + i + 1 >= SIZE)
//             continue;
//         line[12 + i] = board[aimx][aimy + i + 1];
//     }
//     for (int i = 0; i < 4; i ++) {
//         if (aimx - i - 1 < 0 || aimy - i - 1 < 0)
//             continue;
//         line[20 - i - 1] = board[aimx - i - 1][aimy - i - 1];
//     }
//     for (int i = 0; i < 4; i ++) {
//         if (aimx - i - 1 < 0 || aimy + i + 1 >= SIZE)
//             continue;
//         line[20 + i] = board[aimx - i - 1][aimy + i + 1];
//     }
//     for (int i = 0; i < 4; i ++) {
//         if (aimx + i + 1 >= SIZE || aimy - i - 1 < 0)
//             continue;
//         line[28 - i - 1] = board[aimx + i + 1][aimy - i - 1];
//     }
//     for (int i = 0; i < 4; i ++) {
//         if (aimx + i + 1 >= SIZE || aimy + i + 1 >= SIZE)
//             continue;
//         line[28 + i] = board[aimx + i + 1][aimy + i + 1];
//     }
    
//     for (int i = 0; i < 5; i ++) {
//         if (line[0 + i] == enemy) {
//             if (line[0 + i + 1] == enemy && line[0 + i + 2] == enemy && line[0 + i + 3] == enemy) {
//                 newval += 200005;
//                 break;
//             }
//             else if (line[0 + i + 1] == enemy && line[0 + i + 2] == enemy && !line[0 + i + 3]) {
//                 newval += 200000;
//                 break;
//             }
//             else if (line[0 + i + 1] == enemy && line[0 + i + 3] == enemy && !line[0 + i + 2]) {
//                 newval += 10000;
//                 break;
//             }
//             else if (line[0 + i + 3] == enemy && line[0 + i + 2] == enemy && !line[0 + i + 1]) {
//                 newval += 200000;
//                 break;
//             }
//             else if (line[0 + i + 1] == enemy && !line[0 + i + 2] && !line[0 + i + 3]) {
//                 newval += 10000;
//                 break;
//             }
//             else if (line[0 + i + 2] == enemy && !line[0 + i + 1] && !line[0 + i + 3]) {
//                 newval += 5000;
//                 break;
//             }
//             else if (line[0 + i + 3] == enemy && !line[0 + i + 2] && !line[0 + i + 1]) {
//                 newval += 10000;
//                 break;
//             }
//             else if (!line[0 + i + 1] && !line[0 + i + 2] && !line[0 + i + 3]) {
//                 newval += 5;
//                 break;
//             }
//         }
//         else if (!line[0 + i]) {
//             if (line[0 + i + 1] == enemy) {
//                 if (line[0 + i + 2] == enemy && line[0 + i + 3] == enemy) {
//                     newval += 10000;
//                     break;
//                 }
//                 else if (line[0 + i + 2] == enemy && !line[0 + i + 3]) {
//                     newval += 50;
//                     break;
//                 }
//                 else if (line[0 + i + 3] == enemy && !line[0 + i + 2]) {
//                     newval += 50;
//                     break;
//                 }
//                 else if (!line[0 + i + 2] && !line[0 + i + 3]) {
//                     newval += 5;
//                     break;
//                 }
//             }
...
//         if (line[8 + i] == enemy) {
//             if (line[8 + i + 1] == enemy && line[8 + i + 2] == enemy && line[8 + i + 3] == enemy) {
//                 newval += 200005;
//                 break;
//             }
//             else if (line[8 + i + 1] == enemy && line[8 + i + 2] == enemy && !line[8 + i + 3]) {
//                 newval += 200000;
//                 break;
//             }
//             else if (line[8 + i + 1] == enemy && line[8 + i + 3] == enemy && !line[8 + i + 2]) {
//                 newval += 10000;
//                 break;
//             }
//             else if (line[8 + i + 3] == enemy && line[8 + i + 2] == enemy && !line[8 + i + 1]) {
//                 newval += 200000;
//                 break;
//             }
//             else if (line[8 + i + 1] == enemy && !line[8 + i + 2] && !line[8 + i + 3]) {
//                 newval += 10000;
//                 break;
//             }
//             else if (line[8 + i + 2] == enemy && !line[8 + i + 1] && !line[8 + i + 3]) {
//                 newval += 5000;
//                 break;
//             }
//             else if (line[8 + i + 3] == enemy && !line[8 + i + 2] && !line[8 + i + 1]) {
//                 newval += 10000;
//                 break;
//             }
//             else if (!line[8 + i + 1] && !line[8 + i + 2] && !line[8 + i + 3]) {
//                 newval += 5;
//                 break;
//             }
//         }
//         else if (!line[8 + i]) {
//             if (line[8 + i + 1] == enemy) {
//                 if (line[8 + i + 2] == enemy && line[8 + i + 3] == enemy) {
//                     newval += 10000;
//                     break;
//                 }
//                 else if (line[8 + i + 2] == enemy && !line[8 + i + 3]) {
//                     newval += 50;
//                     break;
//                 }
//                 else if (line[8 + i + 3] == enemy && !line[8 + i + 2]) {
//                     newval += 50;
//                     break;
//                 }
//                 else if (!line[8 + i + 2] && !line[8 + i + 3]) {
//                     newval += 5;
//                     break;
//                 }
//             }
...
//         if (line[16 + i] == enemy) {
//             if (line[16 + i + 1] == enemy && line[16 + i + 2] == enemy && line[16 + i + 3] == enemy) {
//                 newval += 200005;
//                 break;
//             }
//             else if (line[16 + i + 1] == enemy && line[16 + i + 2] == enemy && !line[16 + i + 3]) {
//                 newval += 200000;
//                 break;
//             }
//             else if (line[16 + i + 1] == enemy && line[16 + i + 3] == enemy && !line[16 + i + 2]) {
//                 newval += 10000;
//                 break;
//             }
//             else if (line[16 + i + 3] == enemy && line[16 + i + 2] == enemy && !line[16 + i + 1]) {
//                 newval += 200000;
//                 break;
//             }
//             else if (line[16 + i + 1] == enemy && !line[16 + i + 2] && !line[16 + i + 3]) {
//                 newval += 10000;
//                 break;
//             }
//             else if (line[16 + i + 2] == enemy && !line[16 + i + 1] && !line[16 + i + 3]) {
//                 newval += 5000;
//                 break;
//             }
//             else if (line[16 + i + 3] == enemy && !line[16 + i + 2] && !line[16 + i + 1]) {
//                 newval += 10000;
//                 break;
//             }
//             else if (!line[16 + i + 1] && !line[16 + i + 2] && !line[16 + i + 3]) {
//                 newval += 5;
//                 break;
//             }
//         }
//         else if (!line[16 + i]) {
//             if (line[16 + i + 1] == enemy) {
//                 if (line[16 + i + 2] == enemy && line[16 + i + 3] == enemy) {
//                     newval += 10000;
//                     break;
//                 }
//                 else if (line[16 + i + 2] == enemy && !line[16 + i + 3]) {
//                     newval += 50;
//                     break;
//                 }
//                 else if (line[16 + i + 3] == enemy && !line[16 + i + 2]) {
//                     newval += 50;
//                     break;
//                 }
//                 else if (!line[16 + i + 2] && !line[16 + i + 3]) {
//                     newval += 5;
//                     break;
//                 }
//             }
//             else if (!line[16 + i + 1]) {
//                 if (line[16 + i + 2] == enemy) {
//                     if (line[16 + i + 3] == enemy) {
//                         newval += 50;
//                         break;
//                     }
//                     else if (!line[16 + i + 3]) {
...
//         if (line[24 + i] == enemy) {
//             if (line[24 + i + 1] == enemy && line[24 + i + 2] == enemy && line[24 + i + 3] == enemy) {
//                 newval += 200005;
//                 break;
//             }
//             else if (line[24 + i + 1] == enemy && line[24 + i + 2] == enemy && !line[24 + i + 3]) {
//                 newval += 200000;
//                 break;
//             }
//             else if (line[24 + i + 1] == enemy && line[24 + i + 3] == enemy && !line[24 + i + 2]) {
//                 newval += 10000;
//                 break;
//             }
//             else if (line[24 + i + 3] == enemy && line[24 + i + 2] == enemy && !line[24 + i + 1]) {
//                 newval += 200000;
//                 break;
//             }
//             else if (line[24 + i + 1] == enemy && !line[24 + i + 2] && !line[24 + i + 3]) {
//                 newval += 10000;
//                 break;
//             }
//             else if (line[24 + i + 2] == enemy && !line[24 + i + 1] && !line[24 + i + 3]) {
//                 newval += 5000;
//                 break;
//             }
//             else if (line[24 + i + 3] == enemy && !line[24 + i + 2] && !line[24 + i + 1]) {
//                 newval += 10000;
//                 break;
//             }
//             else if (!line[24 + i + 1] && !line[24 + i + 2] && !line[24 + i + 3]) {
//                 newval += 5;
//                 break;
//             }
//         }
//         else if (!line[24 + i]) {
//             if (line[24 + i + 1] == enemy) {
//                 if (line[24 + i + 2] == enemy && line[24 + i + 3] == enemy) {
//                     newval += 10000;
//                     break;
//                 }
//                 else if (line[24 + i + 2] == enemy && !line[24 + i + 3]) {
//                     newval += 50;
//                     break;
//                 }
//                 else if (line[24 + i + 3] == enemy && !line[24 + i + 2]) {
//                     newval += 50;
//                     break;
//                 }
//                 else if (!line[24 + i + 2] && !line[24 + i + 3]) {
//                     newval += 5;
//                     break;
//                 }
//             }
//             else if (!line[24 + i + 1]) {
//                 if (line[24 + i + 2] == enemy) {
//                     if (line[24 + i + 3] == enemy) {
//                         newval += 50;
//                         break;
//                     }
//                     else if (!line[24 + i + 3]) {
